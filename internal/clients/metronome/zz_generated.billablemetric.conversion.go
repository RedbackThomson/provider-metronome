...
import v1alpha1 "github.com/redbackthomson/provider-metronome/apis/billablemetric/v1alpha1"

// +k8s:deepcopy-gen=false
type BillableMetricConverterImpl struct{}

func (c *BillableMetricConverterImpl) FromBillableMetric(source *BillableMetric) *v1alpha1.ObservedBillableMetric {
...
func (c *BillableMetricConverterImpl) FromBillableMetricSpec(source *v1alpha1.BillableMetricParameters) *CreateBillableMetricRequest {
	var pMetronomeCreateBillableMetricRequest *CreateBillableMetricRequest
	if source != nil {
		var metronomeCreateBillableMetricRequest CreateBillableMetricRequest
		metronomeCreateBillableMetricRequest.Name = (*source).Name
		metronomeCreateBillableMetricRequest.AggregationType = AggregationType((*source).AggregationType)
		...
		if (*source).PropertyFilters != nil {
			metronomeCreateBillableMetricRequest.PropertyFilters = make([]PropertyFilter, len((*source).PropertyFilters))
			for i := 0; i < len((*source).PropertyFilters); i++ {
...
func (c *BillableMetricConverterImpl) ToBillableMetric(source *v1alpha1.ObservedBillableMetric) *BillableMetric {
	...
	if source != nil {
		var metronomeBillableMetric BillableMetric
		metronomeBillableMetric.ID = (*source).ID
		metronomeBillableMetric.Name = (*source).Name
		metronomeBillableMetric.AggregationType = AggregationType((*source).AggregationType)
		...
		if (*source).PropertyFilters != nil {
			metronomeBillableMetric.PropertyFilters = make([]PropertyFilter, len((*source).PropertyFilters))
			for i := 0; i < len((*source).PropertyFilters); i++ {
...
func (c *BillableMetricConverterImpl) ToBillableMetricSpec(source *CreateBillableMetricRequest) *v1alpha1.BillableMetricParameters {
	var pV1alpha1BillableMetricParameters *v1alpha1.BillableMetricParameters
	if source != nil {
		var v1alpha1BillableMetricParameters v1alpha1.BillableMetricParameters
		v1alpha1BillableMetricParameters.Name = (*source).Name
...
func (c *BillableMetricConverterImpl) metronomeEventTypeFilterToV1alpha1EventTypeFilter(source EventTypeFilter) v1alpha1.EventTypeFilter {
...
func (c *BillableMetricConverterImpl) metronomePropertyFilterToV1alpha1PropertyFilter(source PropertyFilter) v1alpha1.PropertyFilter {
...
func (c *BillableMetricConverterImpl) v1alpha1EventTypeFilterToMetronomeEventTypeFilter(source v1alpha1.EventTypeFilter) EventTypeFilter {
	var metronomeEventTypeFilter EventTypeFilter
	if source.InValues != nil {
...
func (c *BillableMetricConverterImpl) v1alpha1PropertyFilterToMetronomePropertyFilter(source v1alpha1.PropertyFilter) PropertyFilter {
	var metronomePropertyFilter PropertyFilter
